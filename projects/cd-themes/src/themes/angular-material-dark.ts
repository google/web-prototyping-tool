...
export const buildAngularMaterialDark = (): ITheme =>
  new ThemeFactory(Theme.AngularMaterialDark, 'Angular Material Dark')
    .addPrimaryColor('#e91e63')
    .addSecondaryColor('#607d8b')
    .addWarningColor('#f44336')
    .addSuccessColor('#007E33')
    .addTextColor('rgba(255,255,255,0.6)')
    .addTextDarkColor('rgba(255,255,255,0.87)')
    .addTextLightColor('#FFFFFF')
    .addBorderColor('rgba(255,255,255,0.12)')
    .addSurfaceColor('#303030')
    .addBackgroundBase('#303030')
